...
>
    ...
    <div class="flex-col w-full">
        <div class="mb-2">
            @foreach ($field->values($this->store) as $key => $value)
        ...
        @if ($field->meta('has_add_button'))
            ...
            <x-move-modal
                wire:model="showModal.json{{ $field->attribute }}"
                wire:key="json-{{ $field->attribute }}-modal-create-item"
            >
                <x-slot name="button">
                    <div

...
@php
    $aClasses = $sub
        ? ($active
            ...
            : 'group w-full flex items-center pl-11 pr-2 py-2 text-sm leading-5 font-medium text-gray-200 rounded-md hover:text-white hover:bg-green-700 focus:outline-none focus:text-white focus:bg-green-800 transition ease-in-out duration-150'
        )
        : ($active

<form x-data="{ open: @entangle('showSearchResult') }"
      ...
      method="GET"
>
    <label for="search_field" class="sr-only">Druk op / om te zoeken</label>
    <div class="relative w-full text-gray-400 focus-within:text-gray-600">
        ...
        <input x-on:click="open = true" wire:model="search" id="search_field" class="block w-full h-full pl-8 pr-3 py-2 rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 sm:text-sm" placeholder="Druk op / om te zoeken" type="search">
    </div>
